"""Business profile CRUD + on-demand audit trigger."""
...
def create_business(
    ...
    # Plan gating (§3.6): Starter is limited to a single business/category+city.
...
async def run_check(
    ...
    """Trigger an immediate Gemini check for this business (stores a snapshot)."""
